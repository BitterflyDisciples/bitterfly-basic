//------------------------------------------------------------------------------
/*
  This file is part of bvcd: https://github.com/BVC/BVC-core
  Copyright (c) 2012-2015 BVC Alliance.
...
#define BVC_SQLITE_CPP_INCLUDED
...
#if defined BVC_SQLITE_USE_NDEBUG && !defined (NDEBUG)
#define NDEBUG
#endif
