//------------------------------------------------------------------------------
/*
    This file is part of bitterfly-basic: https://github.com/BitterflyDisciples/bitterfly-basic
    Copyright (c) 2020 Bitterfly.
...
#include <bitterfly/app/consensus/RCLCxTraits.h>
#include <bitterfly/app/ledger/InboundLedgers.h>
#include <bitterfly/app/ledger/LedgerMaster.h>
#include <bitterfly/app/ledger/LedgerTiming.h>
#include <bitterfly/app/ledger/LedgerToJson.h>
#include <bitterfly/app/ledger/LocalTxs.h>
#include <bitterfly/app/ledger/OpenLedger.h>
#include <bitterfly/app/ledger/impl/LedgerConsensusImp.h>
#include <bitterfly/app/ledger/impl/TransactionAcquire.h>
#include <bitterfly/app/main/Application.h>
#include <bitterfly/app/misc/AmendmentTable.h>
#include <bitterfly/app/misc/CanonicalTXSet.h>
#include <bitterfly/app/misc/HashRouter.h>
#include <bitterfly/app/misc/LoadFeeTrack.h>
#include <bitterfly/app/misc/NetworkOPs.h>
#include <bitterfly/app/misc/TxQ.h>
#include <bitterfly/app/misc/Validations.h>
#include <bitterfly/app/misc/ValidatorList.h>
#include <bitterfly/app/tx/apply.h>
#include <bitterfly/basics/contract.h>
#include <bitterfly/basics/CountedObject.h>
#include <bitterfly/basics/Log.h>
#include <bitterfly/core/Config.h>
#include <bitterfly/core/JobQueue.h>
#include <bitterfly/core/TimeKeeper.h>
#include <bitterfly/json/to_string.h>
#include <bitterfly/overlay/Overlay.h>
#include <bitterfly/overlay/predicates.h>
#include <bitterfly/protocol/digest.h>
#include <bitterfly/protocol/st.h>
#include <bitterfly/protocol/Feature.h>
#include <bitterfly/beast/core/LexicalCast.h>
#include <bitterfly/basics/make_lock.h>
#include <type_traits>
...
void LedgerConsensusImp<Traits>::checkLCL ()
{
    ...
    if (netLgr != prevLedgerHash_)
    {
        ...
        JLOG (j_.warn()) << prevLedgerHash_
            << " to " << netLgr;
        JLOG (j_.warn())
            << sdchain::getJson (*previousLedger_);
...
void LedgerConsensusImp<Traits>::statePreClose ()
{
    ...
    auto const idleInterval = LEDGER_IDLE_INTERVAL / 2;/*std::max<seconds>(LEDGER_IDLE_INTERVAL,
